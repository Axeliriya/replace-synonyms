...
export const Main = () => {
  ...
  const onOpenModal = () => {
    ...
    if (showModal) {
      const widthScroll = document.html.offsetWidth - document.html.clientWidth;
      console.log(widthScroll);
      document.body.style.overflow = 'visible';
    } else {
      const widthScroll = document.body.offsetWidth - document.body.clientWidth;
      console.log(widthScroll);
